...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 700+ shows. Specialist in Agra's highly prestigious heritage sector, executing flawless bilingual ceremonies at The Oberoi Amarvilas and ITC Mughal.",
  url: `https://${DOMAIN}`,
