...
const webPageSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  "@id": `https://yashsoni.in/anchor-in-mount-abu/#webpage`,
  url: FULL_URL,
...
const howToSchema = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: `How to Hire the Best Anchor in Mount Abu`,
  description: `Step-by-step process to book Anchor Yash Soni for weddings and corporate events in Mount Abu.`,
  totalTime: "PT48H",
  step: [
    { "@type": "HowToStep", position: 1, name: "Check Availability", text: `WhatsApp +91 7737877978 with your event dates and venues in Mount Abu.` },
