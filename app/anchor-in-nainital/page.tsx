...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 700+ shows. Specialist in Nainital's high-altitude luxury sector, executing flawless bilingual ceremonies across Kumaon lakeside heritage properties.",
  url: `https://${DOMAIN}`,
