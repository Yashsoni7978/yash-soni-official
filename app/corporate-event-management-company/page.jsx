...
export default function CorporateEventManagementCompany() {
    ...
    <div ref={containerRef} className="bg-[#FAF9F6] text-[#1A1A1A] w-full min-h-screen overflow-hidden selection:bg-[#D4AF37] selection:text-white">
      ...
      <section className="relative w-full h-screen flex items-end pb-24 md:pb-32 px-6 md:px-12 lg:px-24">
        <motion.div style={{ y }} className="absolute inset-0 z-0">
          <Image
            src="/corporate_hero_1776855145552.webp"
        ...
        >
          ...
          <h1 className="font-['Runiga'] text-5xl md:text-7xl lg:text-[100px] leading-[0.85] text-[#1A1A1A] mb-8">Engineering Brand Impact</h1>
          <p className="font-['Amandine'] text-3xl md:text-5xl text-[#D4AF37] mb-10">Defining the corporate standard for India's industry leaders</p>
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-[#FAF9F6]">
        ...
        >
          ...
          <h2 className="font-['The_Seasons'] text-4xl md:text-6xl text-[#1A1A1A] leading-tight mb-10">A corporate event is not a party. It is a statement of your brand's authority.</h2>
          <p className="font-sans text-lg md:text-xl text-gray-600 font-light leading-relaxed">We specialize in high-stakes award nights, global summits, and product launches. Precision logistics meets cinematic production to ensure your brand shines.</p>
        </motion.div>
      </section>
      ...
      <section className="py-40 px-6 md:px-12 lg:px-24 bg-[#FAF9F6]">
        ...
        >
          <p className="font-['Kugile_Regular'] text-5xl md:text-7xl lg:text-[90px] leading-[1.1] text-[#1A1A1A]">"Leadership is <span className=\"text-[#D4AF37]\">clarity</span>. Your event should be the clearest expression of your vision."</p>
        </motion.div>
      </section>
      ...
      <section className="py-32 bg-[#1A1A1A] text-[#FAF9F6] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-24">
          ...
          <div className="space-y-24 border-l border-[#D4AF37]/30 ml-4 md:ml-12 pl-8 md:pl-16 relative">
            {[
            { title: "Strategic Planning", desc: "Aligning event goals with brand identity.", img: "/ivory_vintage_car_1776854011319.webp" },
            { title: "Global Summits", desc: "Managing international delegates and VIPs.", img: "/ivory_palace_venue_1776853964418.webp" },
            { title: "Award Ceremonies", desc: "Sharp, timed-to-the-second gala productions.", img: "/ivory_sangeet_stage_1776854029383.webp" },
            { title: "Product Launches", desc: "Immersive experiences that define markets.", img: "/ivory_hero_wedding_1776853928413.webp" }
          ].map((stage, idx) => (
              <motion.div
                key={idx}
      ...
      <section className="py-12 bg-[#1A1A1A] text-center px-6">
        <div className="max-w-5xl mx-auto border-t border-[#FAF9F6]/10 pt-12">
          <p className="font-sans text-[10px] md:text-xs text-[#FAF9F6]/30 leading-loose text-justify text-balance">
            Leading corporate event management company in Jaipur. Handling summits, massive award nights, and international dealer meets. Corporate Event Management Jaipur execution managed by Anchor Yash Soni across Rambagh Palace, Fairmont, and elite destinations.
          </p>
        </div>
      </section>
