    ...
    <div ref={containerRef} className="bg-[#FAF9F6] text-[#1A1A1A] w-full min-h-screen overflow-hidden selection:bg-[#1E3A8A] selection:text-white">
      ...
      <section className="relative w-full h-screen flex items-end pb-24 md:pb-32 px-6 md:px-12 lg:px-24 ">
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeInUp}
          className="relative z-20 backdrop-blur-xl /60 p-8 md:p-14 lg:p-20 max-w-3xl shadow-2xl border-l-4 border-[#1E3A8A]"
        >
      ...
      <section className="py-20  overflow-hidden whitespace-nowrap flex items-center border-y border-[#1E3A8A]/30">
      ...
      <section className="py-24  border-b border-[#1E3A8A]/30">
      ...
      <section className="py-24 bg-[#0F172A] text-white px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Tier 1 */}
            <div className="border border-white/10 p-10 hover:border-[#1E3A8A]/50 transition-colors duration-500 group rounded-lg /30">
