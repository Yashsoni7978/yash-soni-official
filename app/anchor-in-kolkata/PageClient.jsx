...
import { ArrowRight, Award, Briefcase, Building2, CalendarCheck, CheckCircle2, Crown, Gem, Heart, Landmark, MapPin, Mic2, Minus, Music2, Plus, ShieldCheck, Sparkles, Star, Users } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <Reveal>
              ...
              <p className="text-zinc-400 text-lg md:text-xl mb-6 leading-relaxed font-light">
                With 4+ years on stage and 1,100+ events handled instinctively, <strong className="text-white">Anchor Yash Soni</strong> represents the absolute summit of elite hosting for Kolkata’s business families.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Reveal>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash in Kolkata" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              </Reveal>
            </div>
          </div>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-5.webp","/gallery-3.webp","/gallery-1.webp","/gallery-4.webp","/gallery-2.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni Kolkata event ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              ))}
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group">
              <Image src="/backgrounds/kolkata_bg.webp" alt="Kolkata Event Command" fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
