...
const personSchema = {
  ...
  description: "Professional event anchor and emcee with 5+ years and 700+ shows. Specialist in Kolkata's high-net-worth Marwari weddings at ITC Royal Bengal and corporate summits in Rajarhat. Impeccable bilingual English/Hindi execution.",
  url: `https://${DOMAIN}`,
...
const howToSchema = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: `How to Hire the Best Anchor in Kolkata`,
  description: `Step-by-step process to book Anchor Yash Soni for weddings and corporate events in Kolkata.`,
  totalTime: "PT48H",
  step: [
    { "@type": "HowToStep", position: 1, name: "Check Availability", text: `WhatsApp +91 7737877978 with your event dates and venues in Kolkata.` },
