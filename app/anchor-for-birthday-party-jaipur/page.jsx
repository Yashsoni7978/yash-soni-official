  ...
  return (
    <div onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}
      ...
      <button onClick={() => setOpen(o=>!o)} aria-expanded={open} aria-controls={id}
        ...
        <span className={`font-semibold text-sm md:text-base leading-snug pr-2 transition-colors ${open ? "text-[#D4AF37]" : "text-zinc-200 hover:text-white"}`}>{q}</span>
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-12 w-full">
          <motion.div initial={{ opacity:0, y:32 }} animate={{ opacity:1, y:0 }} transition={{ duration:1 }}>
            <div className="inline-flex items-center gap-3 border border-[#D4AF37]/40 px-5 py-2 rounded-full bg-black/40 backdrop-blur-sm mb-7">
              <Cake size={12} className="text-[#D4AF37]"/>
              <span className="text-[#D4AF37] text-[9px] font-bold uppercase tracking-[.3em]">Birthday Party Anchor · Jaipur</span>
            </div>
      ...
      <section className="py-16 md:py-24 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
          <Reveal>
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[.3em] mb-4">The Problem</p>
            ...
            <p className="text-zinc-300 text-sm font-semibold border-l-2 border-[#D4AF37]/50 pl-4">
              The right anchor doesn't just fill time between cake and dancing. The right anchor <em className="text-[#D4AF37]">makes the birthday</em>.
            </p>
          </Reveal>
          <Reveal delay={.1}>
            <div className="img-h relative aspect-[4/5] rounded-2xl overflow-hidden border border-[#D4AF37]/20">
              ...
              <div className="absolute bottom-5 left-5 right-5 bg-black/60 backdrop-blur-sm border border-[#D4AF37]/20 rounded-xl p-4">
                <p className="text-[#D4AF37] text-[9px] font-bold uppercase tracking-widest mb-1">Live · Unscripted · Personalised</p>
                ...
                <div className="bg-[#0a0a0a] border border-white/8 hover:border-[#D4AF37]/40 rounded-2xl p-7 transition-all group hover:bg-zinc-900/60 h-full relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-xl bg-[#D4AF37]/10 flex items-center justify-center group-hover:bg-[#D4AF37] transition-all">
                      <p.icon size={16} className="text-[#D4AF37] group-hover:text-black transition-colors"/>
                    </div>
                    <span className="text-[9px] font-bold uppercase tracking-widest text-[#D4AF37]/70 border border-[#D4AF37]/20 px-2.5 py-1 rounded-full">{p.tag}</span>
                  </div>
                  <h3 className="text-lg font-black text-white uppercase tracking-tight mb-1 group-hover:text-[#D4AF37] transition-colors">{p.title}</h3>
                  <p className="text-[#D4AF37]/50 text-[9px] font-bold uppercase tracking-widest mb-4">{p.sub}</p>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <div className="flex justify-between items-end flex-wrap gap-4 mb-10">
              ...
              <Link href="/portfolio"><span className="text-[#D4AF37] text-[9px] font-bold uppercase tracking-widest border-b border-[#D4AF37]/40 pb-0.5 cursor-pointer">View Portfolio →</span></Link>
            </div>
          </Reveal>
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {VENUES.map((v, i) => (
              <Reveal key={i} delay={i*.03}>
                <span className="text-[10px] font-medium uppercase tracking-widest border border-white/10 hover:border-[#D4AF37]/40 px-4 py-2 rounded-full text-zinc-400 hover:text-[#D4AF37] transition-all cursor-default">
                  {v}
                </span>
              </Reveal>
            ))}
              ...
              <Reveal key={i} delay={i*.08}>
                <a href="https://share.google/pMZGzEGOhXnJpLq5g" target="_blank" rel="noopener noreferrer"
                  ...
                  <div className="flex gap-0.5 mb-4">
                    {[...Array(t.rating)].map((_,j) => <Star key={j} size={11} fill={GOLD} className="text-[#D4AF37]"/>)}
                  </div>
      ...
      <section className="py-24 md:py-32 px-5 md:px-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mx-auto">
          <Reveal>
            <Cake size={24} className="text-[#D4AF37] mx-auto mb-6 opacity-60"/>
