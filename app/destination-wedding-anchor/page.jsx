...
// --- 2. FAQ COMPONENT (Matches Home Page) ---
...
export default function DestinationAnchor() {
  return (
    <div className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black">
      ...
      <div className="bg-[#D4AF37] text-black py-4 overflow-hidden shadow-lg relative z-20">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-10 border-l-4 border-[#D4AF37] pl-6">
                 I act as the <strong className="text-white">"Social Glue"</strong> that binds the two families together. From the Welcome Lunch to the After-Party, I ensure the energy never drops.
              </p>
           ...
           <div className="relative h-[600px] w-full">
              ...
              <div className="absolute top-0 right-0 w-3/4 h-3/4 bg-neutral-800 rounded-2xl overflow-hidden transform rotate-3 border border-neutral-700">
                 <img src="/gallery-5.webp" className="w-full h-full object-cover grayscale opacity-60" alt="Destination Vibe" />
              </div>
              <div className="absolute bottom-0 left-0 w-3/4 h-3/4 bg-black rounded-2xl overflow-hidden shadow-2xl border border-[#D4AF37] transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                 <img src="/intro-portrait-top.webp" className="w-full h-full object-cover" alt="Anchor Yash Travel" />
              </div>
           </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-[#0a0a0a] text-center relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 relative z-10">
            ...
            <p className="text-[#D4AF37] max-w-2xl mx-auto mb-12 text-xl font-light">
               Dates for Destination Weddings are booking 8-12 months in advance.
            </p>
            <Link href="/contact">
               <button className="px-12 py-5 bg-[#D4AF37] text-black font-bold uppercase tracking-widest hover:bg-white hover:scale-105 transition-transform rounded-full shadow-2xl">
                  Inquire Now
               </button>
            </Link>
         </div>
...
const LocationCard = ({ name, tag, img, colSpan = "" }) => (
    <div className={`relative rounded-2xl overflow-hidden group cursor-pointer border border-white/5 hover:border-[#D4AF37]/50 transition-colors duration-500 ${colSpan}`}>
        ...
        <div className="absolute bottom-6 left-6">
            <p className="text-white font-black text-3xl uppercase tracking-wider">{name}</p>
            <div className="flex items-center gap-2 text-[#D4AF37] text-xs font-bold uppercase tracking-widest mt-2 drop-shadow-md">
