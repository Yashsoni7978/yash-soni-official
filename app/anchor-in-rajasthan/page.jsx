...
import {
  Mic2, Star, Users, Award, Sparkles, MapPin,
  Heart, Music2, Crown, Globe, CalendarCheck,
  Plus, Minus, CheckCircle2, ArrowRight,
  Building2, Landmark, Camera, ChevronRight, Zap
} from "lucide-react";
...
const STATS = [
  ...
  { val:"7",    suffix:"+", label:"Rajasthan Cities",    sub:"Covered",                  icon:MapPin   },
...
const CITIES = [
  {
    ...
    venues:"Rambagh Palace · Fairmont · Leela · JECC Sitapura · Amer Road farmhouses",
    desc:"The Pink City headquarters. Palace buyouts, corporate summits at JECC Sitapura, and every format of wedding across Kukas, Amer Road, Ajmer Road, and Mansarovar. Deep venue relationships and first-name protocol at every major property.",
    highlight:true,
  },
  {
    city:"Udaipur",
    tag:"Lake City",
    href:"/anchor-in-jaipur",
    venues:"Taj Lake Palace · Oberoi Udaivilas · Leela Udaipur · RAAS",
    desc:"Rajasthan's most romantic destination wedding city. Taj Lake Palace ceremonies, Oberoi Udaivilas heritage events, and RAAS sundowner Sangeets. NRI families choose Udaipur first — the anchor needs international protocols and deep venue knowledge.",
  },
  {
    city:"Jodhpur",
    tag:"Blue City",
    ...
    desc:"Umaid Bhawan Palace — one of the last functioning royal residences in India. Heritage fort Sangeets at Mehrangarh. These venues demand a hosting register that matches the grandeur of the architecture without trying to outshout it.",
  },
  {
    city:"Jaisalmer",
    tag:"Desert City",
    href:"/anchor-in-jaipur",
    venues:"Suryagarh · Serai · Marriott Jaisalmer · Desert camps",
    desc:"Open-air desert weddings with acoustic challenges that break unprepared anchors. Sufi night Sangeets at Suryagarh. Desert camp Haldis at sunrise. The energy management for outdoor desert events is a completely different discipline.",
  },
  {
    city:"Pushkar",
    tag:"Spiritual City",
    href:"/anchor-in-jaipur",
    venues:"Westin Pushkar · Ananta Spa · Tivoli Pushkar",
    desc:"Bohemian destination weddings, multi-day resort events, and pool party Haldis at Westin Pushkar. The Pushkar crowd is typically younger, destination-focused, and expects an anchor who matches that energy and aesthetic.",
  },
  {
    city:"Bikaner",
    tag:"Heritage City",
    href:"/anchor-in-jaipur",
    venues:"Narendra Bhawan · Lallgarh Palace · Bhanwar Niwas",
    desc:"Narendra Bhawan's intimate luxury and Lallgarh Palace's grand courtyard Sangeets. Heritage Rajasthani families with strong cultural traditions that the anchor needs to navigate with genuine knowledge — not a template.",
  },
  {
    city:"Ajmer",
    tag:"Pilgrim City",
    href:"/anchor-in-jaipur",
    venues:"Haveli Darbar · Merwara Estate · Ana Sagar lakeside venues",
    desc:"Destination weddings at heritage estates and lakeside venues in the shadow of the Dargah. Events here carry deep cultural significance — the hosting tone must balance festivity with genuine respect for the setting.",
  },
];
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-t border-white/10 pt-8">
              <div>
                <p className="text-zinc-300 text-base md:text-lg font-light leading-relaxed max-w-lg mb-2">
                  Jaipur · Udaipur · Jodhpur · Jaisalmer · Pushkar · Bikaner · Ajmer — every palace, every fort, every desert camp. One anchor. Bilingual. Unscripted.
                </p>
