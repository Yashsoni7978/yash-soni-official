...
const serviceSchema = {
  ...
  description:
    "Premier event anchor across all of Rajasthan. Jaipur, Udaipur, Jodhpur, Jaisalmer, Pushkar, and beyond. Wedding, corporate, and destination event hosting across every major Rajasthan city and venue.",
  provider: {
    "@type": "Person",
    name: "Yash Soni",
