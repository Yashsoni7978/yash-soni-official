...
const services = [
  ...
  { 
    ...
    icon: <Gift className="w-10 h-10 text-[#D4AF37]" />
  },
];
...
export default function EventPlanningPro() {
  ...
  return (
    <div className="bg-[#050505] text-white min-h-screen font-sans overflow-x-hidden selection:bg-[#D4AF37] selection:text-black">
      ...
      <section className="pt-32 pb-10 text-center relative z-10">
        ...
        >
           ...
           <Link href="/contact">
             <button className="px-10 py-4 bg-[#D4AF37] text-black font-bold uppercase tracking-widest hover:bg-white transition-all rounded-full shadow-[0_0_30px_rgba(212,175,55,0.4)]">
               Start Consultation
             </button>
           </Link>
        </motion.div>
      ...
      <section className="relative h-[600px] w-full flex items-center justify-center overflow-hidden py-20">
        ...
        {/* Navigation Buttons */}
        <button onClick={prevSlide} className="absolute left-4 md:left-20 z-50 p-4 bg-black/50 hover:bg-[#D4AF37] hover:text-black rounded-full border border-[#D4AF37]/30 transition-all group">
           <ChevronLeft className="w-8 h-8 text-[#D4AF37] group-hover:text-black" />
        </button>
        <button onClick={nextSlide} className="absolute right-4 md:right-20 z-50 p-4 bg-black/50 hover:bg-[#D4AF37] hover:text-black rounded-full border border-[#D4AF37]/30 transition-all group">
           <ChevronRight className="w-8 h-8 text-[#D4AF37] group-hover:text-black" />
        </button>
               ...
               return (
                 <motion.div
                   ...
                   className={`absolute w-[300px] md:w-[380px] h-[500px] rounded-2xl p-8 flex flex-col justify-end items-center text-center cursor-pointer border transition-all duration-500
                     ${isActive 
                        ? "bg-[#0f0f0f] border-[#D4AF37] shadow-[0_0_50px_rgba(212,175,55,0.2)]" 
                 ...
                 >
                    ...
                    <div className="relative z-10 flex flex-col items-center h-full justify-center">
                       ...
                       <div className={`p-6 rounded-full mb-8 border transition-all duration-500
                          ${isActive 
                             ? "bg-[#D4AF37]/10 border-[#D4AF37] shadow-[0_0_20px_rgba(212,175,55,0.3)] scale-110" 
                             : "bg-[#111] border-[#333]"
                          }
                       `}>
                          {service.icon}
                       ...
                       <p className="text-[#D4AF37] text-xs uppercase tracking-[0.3em] font-bold mb-3">{service.subtitle}</p>
                       ...
                       <AnimatePresence>
                         {isActive && (
                           ...
                           >
                             <p className="text-gray-400 text-sm leading-relaxed mb-8 border-t border-[#D4AF37]/20 pt-6">
                               {service.desc}
                             </p>
                             <Link href="/contact">
                               <button className="px-8 py-3 border border-[#D4AF37] text-[#D4AF37] font-bold uppercase text-[10px] tracking-widest hover:bg-[#D4AF37] hover:text-black transition-all rounded-full">
                                 View Details
                               </button>
                             </Link>
                           </motion.div>
      ...
      <section className="py-24 container mx-auto px-4 border-t border-[#D4AF37]/10 bg-[#0a0a0a]">
         ...
         <div className="grid md:grid-cols-4 gap-4">
            {processSteps.map((step, i) => (
               <div key={i} className="p-8 bg-[#0f0f0f] border border-[#222] hover:border-[#D4AF37]/50 transition-all group hover:-translate-y-2">
                  <div className="text-5xl font-black text-[#222] mb-6 group-hover:text-[#D4AF37]/20 transition-colors">{step.num}</div>
      ...
      <section className="py-24 text-center relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 relative z-10">
            ...
            <p className="text-[#D4AF37] mb-10 text-xl font-light">Let's build your event with precision and style.</p>
            <Link href="/contact">
               <button className="px-14 py-5 bg-[#D4AF37] text-black font-bold uppercase tracking-widest hover:scale-105 transition-transform shadow-[0_0_40px_rgba(212,175,55,0.3)]">
                  Get A Quote
               </button>
            </Link>
         </div>
