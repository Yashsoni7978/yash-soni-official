...
import { Calculator, Crown, MapPin, Minus, Plus, Sparkles, Truck, Utensils } from "lucide-react";
...
const GoldTextureText = ({ children, className }) => (
  <span 
    ...
    style={{ backgroundImage: "linear-gradient(135deg, #BF953F, #FCF6BA, #B38728, #FBF5B7, #AA771C)", backgroundColor: GOLD_COLOR }}
  >
    {children}
  </span>
);
