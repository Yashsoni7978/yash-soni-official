...
import { ArrowRight, Award, Building2, CalendarCheck, CheckCircle2, Crown, Flower2, Gem, Globe, Heart, MapPin, Mic2, Minus, Music2, Plus, ShieldCheck, Sparkles, Star, Sword, Users } from "lucide-react";
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
               ...
               <Reveal>
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash in Jodhpur" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" quality={75} />
                  </div>
               </Reveal>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Why Jodhpur is Different</p>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">The Royal Challenge</p>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-1.webp", "/gallery-3.webp", "/gallery-2.webp", "/gallery-4.webp", "/gallery-5.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni Jodhpur event ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              ))}
            </div>
          ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            {[
              ...
              },
              {
                ...
                title: "Best Sangeet Emcee in Jodhpur",
                desc: "High-energy Sangeet nights, unscripted crowd games, 500–1,500 guests. Dance floors packed until 4 AM. Jodhpur's top-rated Sangeet emcee.",
                keywords: ["best sangeet emcee jodhpur", "sangeet anchor jodhpur", "sangeet host jodhpur"],
              },
              {
                label: "Corporate Host · Corporate MC",
                title: "Best Corporate Emcee in Jodhpur",
                desc: "Award nights, product launches, annual galas at premium properties. Sharp, bilingual, brand-aligned corporate MC hosting.",
                keywords: ["best corporate emcee jodhpur", "corporate anchor jodhpur", "corporate mc jodhpur", "corporate host jodhpur"],
              },
              {
          ...
          <Reveal>
            <div className="border border-white/5 rounded-2xl p-6 bg-[#0a0a0a]">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  "Best Anchor in Jodhpur", "Best Emcee in Jodhpur", "Best Host in Jodhpur",
                  "Wedding Anchor Jodhpur", "Wedding Emcee Jodhpur", "Wedding Host Jodhpur",
                  "Corporate Anchor Jodhpur", "Corporate Emcee Jodhpur", "Corporate MC Jodhpur",
                  "Best Anchor in Rajasthan", "Best Emcee in Rajasthan",
                  "Sangeet Anchor Jodhpur", "Sangeet Emcee Jodhpur", "Sangeet Host Jodhpur",
                  "Haldi Anchor Jodhpur", "Mehendi Host Jodhpur",
                  "Birthday Anchor Jodhpur", "Birthday Emcee Jodhpur",
                  "Master of Ceremonies Jodhpur", "MC for Wedding Jodhpur",
                  "NRI Wedding Emcee Jodhpur", "Bilingual Host Jodhpur",
                  "Top Anchor Jodhpur", "Top Emcee Jodhpur", "Event Host Jodhpur",
                ].map((term, i) => (
