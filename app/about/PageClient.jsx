          ...
          <div className="grid md:grid-cols-[1fr_2px_1.6fr] gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm md:text-base leading-relaxed font-light mb-5">
                I am Yash Soni. Over the last 4+ years and 1,100+ events, I have hosted everything from intimate 50-guest birthday galas in Mansarovar to 1,500-person farmhouse Sangeets on Ajmer Road — from royal Varmala ceremonies at Rambagh Palace to national brand award nights at JECC Sitapura.
              </p>
      ...
      <section className="px-5 md:px-10 py-14 md:py-20 max-w-6xl mx-auto">
        <Reveal>
          ...
          <p className="text-zinc-500 text-sm mb-10 max-w-lg leading-relaxed">
            You don't trust a pilot who hasn't flown. Over the last 4+ years, I have held the mic at some of India's most iconic venues. I know their acoustics, their layouts, and their teams.
          </p>
        </Reveal>
