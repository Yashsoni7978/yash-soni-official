...
const GoldTextureText = ({ children, className }) => (
  <span 
    ...
    style={{ 
      backgroundImage: "url('/gold-texture.webp')", // <-- FIXED TO WEBP
    ...
    <main className="bg-black text-white min-h-screen selection:bg-[#D4AF37] selection:text-black font-sans">
      ...
      <div ref={containerRef} className="relative flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 h-[60vh] lg:h-screen lg:sticky lg:top-0 relative overflow-hidden border-r border-neutral-900 z-10">
          ...
          {/* --- FIXED: Next.js Image Component for LCP Optimization --- */}
          <Image 
            src="/intro-portrait-top.webp" 
            alt="Anchor Yash Soni - Premium Event Emcee in Jaipur" 
            fill
            priority // Forces instant loading for Lighthouse LCP
        ...
        <div className="lg:w-1/2 relative bg-[#050505]">
          ...
          <section className="min-h-screen flex items-center justify-center p-8 md:p-20 border-b border-neutral-900">
            <FadeIn>
              <p className="text-[#D4AF37] text-sm uppercase tracking-[0.3em] mb-6 flex items-center gap-3 font-bold">
              ...
              {/* INCREASED CONTRAST FOR ACCESSIBILITY (text-zinc-300 instead of gray-400) */}
          ...
          <section className="py-20 p-8 md:p-20 border-b border-neutral-900 bg-[#080808]">
            <FadeIn>
              {/* FIXED HEADING TO H2 */}
              <h2 className="text-sm font-bold uppercase tracking-widest text-zinc-400 mb-12">By The Numbers</h2>
              <div className="grid grid-cols-2 gap-12">
                <div>
                  <p className="text-5xl font-display font-black text-white mb-2">1100+</p>
                  <p className="text-[#D4AF37] text-xs uppercase tracking-widest font-bold">Live Events</p>
                </div>
                <div>
                  <p className="text-5xl font-display font-black text-white mb-2">05+</p>
                  <p className="text-[#D4AF37] text-xs uppercase tracking-widest font-bold">Years Experience</p>
                </div>
                <div>
                  <p className="text-5xl font-display font-black text-white mb-2">70+</p>
                  <p className="text-[#D4AF37] text-xs uppercase tracking-widest font-bold">Cities</p>
                </div>
                <div>
                  <p className="text-5xl font-display font-black text-white mb-2">100%</p>
                  <p className="text-[#D4AF37] text-xs uppercase tracking-widest font-bold">Unscripted Energy</p>
                </div>
              </div>
            </FadeIn>
          </section>
          ...
          <section className="min-h-[60vh] flex flex-col justify-center p-8 md:p-20 border-b border-neutral-900 group hover:bg-[#0a0a0a] transition-colors duration-500">
            ...
            <FadeIn>
              <h2 className="text-3xl font-display font-bold text-white mb-6 relative z-10">It Started With a Spark</h2>
              <p className="text-zinc-300 leading-relaxed font-light text-lg relative z-10 mb-6">
              ...
              <p className="text-zinc-300 leading-relaxed font-light text-lg relative z-10">
          ...
          <section className="py-20 p-8 md:p-20 border-b border-neutral-900 bg-[#080808]">
            <FadeIn>
              <p className="text-sm font-bold uppercase tracking-widest text-zinc-400 mb-12">My Philosophy</p>
          ...
          <section className="min-h-[60vh] flex flex-col justify-center p-8 md:p-20 border-b border-neutral-900 group hover:bg-[#0a0a0a] transition-colors duration-500">
            ...
            <FadeIn>
              <h2 className="text-3xl font-display font-bold text-white mb-6 relative z-10">Stages I've Conquered</h2>
              <p className="text-zinc-300 leading-relaxed font-light text-lg relative z-10 mb-8">
              ...
              <div className="grid gap-6 relative z-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    {/* Fixed to H3 to follow H2 */}
                    <h3 className="text-white font-bold mb-1 text-lg">The Palaces</h3>
                    <p className="text-zinc-400 text-sm">Rambagh Palace, Jai Mahal, City Palace Udaipur</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Star className="text-[#D4AF37] w-6 h-6 shrink-0 mt-1" />
                  <div>
                    <h3 className="text-white font-bold mb-1 text-lg">The Luxury Hotels</h3>
                    <p className="text-zinc-400 text-sm">Fairmont Jaipur, Marriott, The Leela</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Briefcase className="text-[#D4AF37] w-6 h-6 shrink-0 mt-1" />
                  <div>
                    <h3 className="text-white font-bold mb-1 text-lg">The Corporate Hubs</h3>
                    <p className="text-zinc-400 text-sm">JECC Sitapura, Birla Auditorium</p>
                  </div>
                </div>
              </div>
          ...
          <section className="py-20 p-8 md:p-20 border-b border-neutral-900 bg-[#080808]">
            <FadeIn>
              <p className="text-sm font-bold uppercase tracking-widest text-zinc-400 mb-12">Signature Style</p>
              ...
              <div className="space-y-6">
                <div className="p-6 border border-neutral-800 rounded-xl bg-neutral-900/50 hover:border-[#D4AF37]/50 transition-colors">
                  <h3 className="text-white font-bold mb-2 flex items-center gap-2 text-lg"><Sparkles size={18} className="text-[#D4AF37]"/> For Sangeets</h3>
                  <p className="text-zinc-400 text-sm">"The Couple Trivia" (Roast edition), "Dance-Offs" (Boys vs. Girls).</p>
                </div>
                <div className="p-6 border border-neutral-800 rounded-xl bg-neutral-900/50 hover:border-[#D4AF37]/50 transition-colors">
                  <h3 className="text-white font-bold mb-2 flex items-center gap-2 text-lg"><Zap size={18} className="text-[#D4AF37]"/> For Corporates</h3>
                  <p className="text-zinc-400 text-sm">"Ice-Breakers" that don't feel awkward, Rapid-fire industry quizzes.</p>
                </div>
              </div>
              <p className="text-zinc-500 italic mt-6 text-sm">The Rule: No one is forced to participate, but everyone will want to.</p>
            </FadeIn>
          </section>
          ...
          <section className="min-h-[60vh] flex flex-col justify-center p-8 md:p-20 border-b border-neutral-900 group hover:bg-[#0a0a0a] transition-colors duration-500">
            ...
            <FadeIn>
              <h2 className="text-3xl font-display font-bold text-white mb-6 relative z-10 flex items-center gap-3">
                <ShieldAlert className="text-[#D4AF37]" /> Crisis Management
              </h2>
              <h3 className="text-2xl font-bold text-white mb-6 relative z-10">Scripts are Safety Nets. I Don't Use Them.</h3>
              <p className="text-zinc-300 leading-relaxed font-light text-lg relative z-10 mb-6">
