...
export const metadata = {
  ...
  description: "Premium event management in Jaipur by Yash Soni Studio. End-to-end planning, coordination and execution for weddings, corporate events and galas across Rajasthan.",
  keywords: [
