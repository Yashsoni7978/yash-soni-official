  ...
  return (
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0"><div class="relative w-full h-full"><Image src="/backgrounds/varanasi_bg.webp" alt="Best Anchor in Varanasi — VIP Spiritual Destination Weddings" fill priority sizes="100vw" className="object-cover slow-zoom" /></div>
