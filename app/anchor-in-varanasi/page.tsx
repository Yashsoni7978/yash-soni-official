...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 700+ shows. Specialist in Varanasi's highly spiritual heritage sector, executing flawless cross-cultural ceremonies at Taj Nadesar Palace and BrijRama.",
  url: `https://${DOMAIN}`,
