...
const STATS = [
  ...
  { val: "700+", label: "Total Events", icon: Mic2 },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              {
                zone: "Jaipur & Rajasthan & Virtual",
                type: "Remote & Hybrid Teams",
                desc: "Virtual team building via Zoom and Microsoft Teams for distributed teams. The same energy, different screen. Companies across Jaipur & Rajasthan with Jaipur offices regularly book virtual sessions.",
