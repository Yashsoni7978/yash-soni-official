...
import { ArrowRight, Award, Briefcase, Building2, CalendarCheck, CheckCircle2, Crown, Flower2, Gem, Globe, Heart, Landmark, MapPin, Mic2, Music2, ShieldCheck, Sparkles, Star, Users } from "lucide-react";
...
const G = ({ children }) => (
  <span
    ...
    style={{ backgroundImage: "url('/texture/kota.webp')", backgroundColor: GOLD }}
  >
    {children}
  </span>
);
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
        ...
        <div className="relative z-20 text-center px-5 max-w-6xl mx-auto">
          ...
          >
            <div className="mb-8 inline-flex items-center gap-3 border border-[#D4AF37]/50 px-6 py-2.5 rounded-full bg-black/60 backdrop-blur-xl shadow-[0_0_24px_rgba(212,175,55,0.2)]">
              ...
              <span className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em]">Best Event Anchor · Kota · The Hadoti Capital</span>
            </div>
            <h1 className="font-black uppercase tracking-tighter leading-[0.82] mb-8">
              ...
              <span
                ...
                style={{ backgroundImage: "url('/texture/kota.webp')" }}
              >
                KOTA
              </span>
            </h1>
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Reveal>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash in Kota" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              </Reveal>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Why Kota is Different</p>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">The Kota Challenge</p>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-5.webp","/gallery-2.webp","/gallery-1.webp","/gallery-4.webp","/gallery-3.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni Kota Hadoti event ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              ))}
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group">
              <Image src="/varmala-fireworks-color-shots.webp" alt="Kota Umed Bhawan Palace Wedding" fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
              ...
              <div className="absolute bottom-5 left-5 right-5 bg-black/60 backdrop-blur-sm border border-[#D4AF37]/20 rounded-xl p-4">
                <p className="text-[#B5952F] text-[9px] font-bold uppercase tracking-widest mb-1">Kota · The Hadoti Core</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            {[
              ...
              },
              {
                ...
                title: "Best Sangeet Emcee in Kota",
                desc: "High-energy Sangeet nights, unscripted crowd games, 500–1,500 guests. Dance floors packed until 4 AM. Kota's top-rated Sangeet emcee.",
                keywords: ["best sangeet emcee kota", "sangeet anchor kota", "sangeet host kota"],
              },
              {
                label: "Corporate Host · Corporate MC",
                title: "Best Corporate Emcee in Kota",
                desc: "Award nights, product launches, annual galas at premium properties. Sharp, bilingual, brand-aligned corporate MC hosting.",
                keywords: ["best corporate emcee kota", "corporate anchor kota", "corporate mc kota", "corporate host kota"],
              },
              {
                label: "Best MC · Best Host · Best Emcee",
                title: "Best Emcee in Kota",
                desc: "4.9★ across 200+ verified reviews. 1,100+ events. The most reviewed event professional in Kota — by any name.",
          ...
          <Reveal>
            <div className="border border-white/5 rounded-2xl p-6 bg-[#0a0a0a]">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  "Best Anchor in " + "Kota", "Best Emcee in " + "Kota", "Best Host in " + "Kota",
                  "Wedding Anchor " + "Kota", "Wedding Emcee " + "Kota", "Wedding Host " + "Kota",
                  "Corporate Anchor " + "Kota", "Corporate Emcee " + "Kota", "Corporate MC " + "Kota",
                  "Best Anchor in Rajasthan", "Best Emcee in Rajasthan",
                  "Sangeet Anchor " + "Kota", "Sangeet Emcee " + "Kota", "Sangeet Host " + "Kota",
                  "Haldi Anchor " + "Kota", "Mehendi Host " + "Kota",
                  "Birthday Anchor " + "Kota", "Birthday Emcee " + "Kota",
                  "Master of Ceremonies " + "Kota", "MC for Wedding " + "Kota",
                  "NRI Wedding Emcee " + "Kota", "Bilingual Host " + "Kota",
                  "Top Anchor " + "Kota", "Top Emcee " + "Kota", "Event Host " + "Kota",
                ].map((term, i) => (
