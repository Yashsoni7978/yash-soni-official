...
import {
  ...
  CalendarCheck, Sparkles, Users, Quote,
  Mic, Award, UserCheck, ArrowRight,
...
const SERVICE_PILLS = [
  ...
  { label: "Haldi Games", href: "/haldi-anchor-jaipur" },
  { label: "Mehendi Anchor", href: "/mehendi-anchor-jaipur" },
  { label: "Corporate Events", href: "/corporate-event-anchor-jaipur" },
  { label: "Birthday Events", href: "/anchor-in-jaipur" },
];
...
const LOCATIONS = [
  { area: "Royal Corridors", zones: "Kukas · Amer Road · Delhi Road", desc: "Palace buyouts and NRI destination weddings." },
  { area: "Grand Venues", zones: "Ajmer Road · Bhankrota · Jhotwara", desc: "Massive 1,000–1,500+ guest celebrations." },
  { area: "Urban Elite", zones: "Mansarovar · Vaishali Nagar · C-Scheme", desc: "Premium banquets and VIP social events." },
  { area: "Corporate Hubs", zones: "Sitapura JECC · Tonk Road · JLN Marg", desc: "Award nights and business galas for national brands." },
];
...
const GALLERY_IMAGES = ["/gallery-1.webp", "/gallery-2.webp", "/gallery-3.webp", "/gallery-4.webp", "/gallery-5.webp", "/gallery-6.webp"];
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <ScrollReveal delay={0.15}>
                <div className="relative aspect-[3/4] rounded-xl overflow-hidden border border-white/10 hover:border-[#D4AF37]/50 group transition-all duration-500">
                  <Image src="/intro-portrait-top.webp" alt="Anchor Yash Soni professional portrait" fill quality={90} className="object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.25} className="mt-8 md:mt-12">
                <div className="relative aspect-[3/4] rounded-xl overflow-hidden border border-white/10 hover:border-[#D4AF37]/50 group transition-all duration-500">
                  <Image src="/intro-portrait-bottom.webp" alt="Anchor Yash Soni engaging with a wedding crowd" fill quality={90} className="object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
              </ScrollReveal>
            </div>
          </div>
              ...
              <ScrollReveal key={i} delay={i * 0.12}>
                <Link href={s.href}>
                  <div className="relative h-[440px] md:h-[520px] rounded-2xl overflow-hidden group border border-white/10 hover:border-[#D4AF37]/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(212,175,55,0.25)] cursor-pointer">
                    <Image src={s.img} alt={`${s.title} — Anchor Yash Soni`} fill quality={85} className="object-cover transition-transform duration-700 group-hover:scale-108" />
        ...
        <div className="container mx-auto px-5 md:px-10">
          <ScrollReveal>
            <div className="text-center mb-10 md:mb-14">
              ...
              <h2 className="text-3xl md:text-5xl font-bold mt-2">
                Jaipur & <GoldText>Beyond.</GoldText>
              </h2>
