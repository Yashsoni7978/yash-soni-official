...
const localBusinessSchema = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 27.2152, longitude: 77.4930 },
...
const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://yashsoni.in" },{ "@type": "ListItem", position: 2, name: "Locations", item: "https://yashsoni.in/locations" },{ "@type": "ListItem", position: 3, name: "Anchor in Bharatpur", item: "https://yashsoni.in/anchor-in-bharatpur" }] };

const webPageSchema = {
  "@context": "https://schema.org", "@type": "WebPage",
  name: "Best Anchor in Bharatpur | Yash Soni — Heritage Wedding Specialist",
  url: "https://yashsoni.in/anchor-in-bharatpur",
  description: "Anchor Yash Soni is Bharatpur's top-rated wedding anchor and emcee — 4.9★ across 200+ reviews. Specialist in heritage weddings, corporate offsites, and destination events in Bharatpur, Rajasthan.",
  inLanguage: "en-IN",
...
const howToSchema = {
  ...
  name: "How to Hire the Best Anchor or Emcee for a Bharatpur Destination Wedding",
  description: "Step-by-step process to book Anchor Yash Soni for heritage weddings and corporate events in Bharatpur, Rajasthan.",
  totalTime: "PT48H",
  step: [
    { "@type": "HowToStep", position: 1, name: "Check Availability", text: "WhatsApp +91 7737877978 with your Bharatpur event date and venue. Peak season dates fill 6+ months ahead." },
    { "@type": "HowToStep", position: 2, name: "Receive Quote", text: "A comprehensive quote covering travel, stay, and event hosting logistics for Bharatpur is provided within the hour." },
...
export const metadata: Metadata = {
  title: "Best Anchor in Bharatpur | Yash Soni — Heritage Wedding Specialist",
  description: "Anchor Yash Soni is Bharatpur's 4.9★ rated wedding anchor and emcee — specialist in heritage weddings, grand Sangeets, and corporate destination events.",
  alternates: { canonical: "https://yashsoni.in/anchor-in-bharatpur" },
  openGraph: { title: "Best Anchor in Bharatpur | Yash Soni", description: "4.9★ rated wedding anchor and emcee in Bharatpur. Heritage weddings and grand destination events.", url: "https://yashsoni.in/anchor-in-bharatpur", siteName: "Anchor Yash Soni", locale: "en_IN", type: "website", images: [{ url: "/og-image.webp", width: 1200, height: 630, alt: "Best Anchor in Bharatpur — Yash Soni" }] },
  twitter: { card: "summary_large_image", title: "Best Anchor in Bharatpur | Yash Soni", description: "4.9★ · 200+ reviews. Bharatpur's top anchor, emcee, and wedding host.", images: [{ url: "/og-image.webp", width: 1200, height: 630 }] },
};
