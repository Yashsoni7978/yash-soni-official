...
import { ArrowRight, Award, Briefcase, Building2, CalendarCheck, CheckCircle2, ChevronRight, Crown, Gem, Heart, Landmark, MapPin, Mic2, Minus, Music2, Plus, ShieldCheck, Sparkles, Speaker, Star, Users } from "lucide-react";
  ...
  return (
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0"><div className="relative w-full h-full"><Image src="/backgrounds/neemrana_bg.webp" alt="Best Anchor in Neemrana — Corporate Retreats & Fort Weddings" fill priority sizes="100vw" className="object-cover slow-zoom" /></div>
