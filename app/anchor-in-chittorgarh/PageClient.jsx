...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Sunrise Haldi and Mehndi events on the terraces of heritage properties overlooking the fort. Creating warmth and genuine inter-guest connection for destination families who have gathered from across Jaipur & Rajasthan and abroad specifically to celebrate in Chittorgarh.",
    tag: "Pre-Wedding"
  },
  {
    icon: Building2,
  ...
  return (
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Reveal>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash at Chittorgarh" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              </Reveal>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12  border-b border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-px bg-white/5 rounded-2xl overflow-hidden border border-white/8">
            <div className=" px-6 py-4 border-b border-white/5"><p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest">What you usually get</p></div>
            ...
            {VS.map((row, i) => (<>
              <div key={`p${i}`} className=" px-6 py-4 border-b border-white/5 last:border-b-0 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-red-500/40 shrink-0" /><p className="text-zinc-500 text-sm">{row.problem}</p></div>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-1.webp","/gallery-5.webp","/gallery-3.webp","/gallery-2.webp","/gallery-4.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni Chittorgarh heritage event ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              ))}
            </div>
          ))}
      ...
      <section className="py-20 md:py-28 px-5 md:px-12  border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group"><Image src="/bride-groom-fort-shoot.webp" alt="Chittorgarh Fort Scale" fill sizes="(max-width:768px) 100vw, 50vw" className="object-cover group-hover:scale-105 transition-transform duration-1000" quality={75} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            {[
              ...
              },
              {
                ...
                title: "Best Sangeet Emcee in Chittorgarh",
                desc: "High-energy Sangeet nights, unscripted crowd games, 500–1,500 guests. Dance floors packed until 4 AM. Chittorgarh's top-rated Sangeet emcee.",
                keywords: ["best sangeet emcee chittorgarh", "sangeet anchor chittorgarh", "sangeet host chittorgarh"],
              },
              {
                label: "Corporate Host · Corporate MC",
                title: "Best Corporate Emcee in Chittorgarh",
                desc: "Award nights, product launches, annual galas at premium properties. Sharp, bilingual, brand-aligned corporate MC hosting.",
                keywords: ["best corporate emcee chittorgarh", "corporate anchor chittorgarh", "corporate mc chittorgarh", "corporate host chittorgarh"],
              },
              {
                label: "Best MC · Best Host · Best Emcee",
                title: "Best Emcee in Chittorgarh",
                desc: "4.9★ across 200+ verified reviews. 1,100+ events. The most reviewed event professional in Chittorgarh — by any name.",
          ...
          <Reveal>
            <div className="border border-white/5 rounded-2xl p-6 bg-[#0a0a0a]">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  "Best Anchor in Chittorgarh", "Best Emcee in Chittorgarh", "Best Host in Chittorgarh",
                  "Wedding Anchor Chittorgarh", "Wedding Emcee Chittorgarh", "Wedding Host Chittorgarh",
                  "Corporate Anchor Chittorgarh", "Corporate Emcee Chittorgarh", "Corporate MC Chittorgarh",
                  "Best Anchor in Rajasthan", "Best Emcee in Rajasthan",
                  "Sangeet Anchor Chittorgarh", "Sangeet Emcee Chittorgarh", "Sangeet Host Chittorgarh",
                  "Haldi Anchor Chittorgarh", "Mehendi Host Chittorgarh",
                  "Birthday Anchor Chittorgarh", "Birthday Emcee Chittorgarh",
                  "Master of Ceremonies Chittorgarh", "MC for Wedding Chittorgarh",
                  "NRI Wedding Emcee Chittorgarh", "Bilingual Host Chittorgarh",
                  "Top Anchor Chittorgarh", "Top Emcee Chittorgarh", "Event Host Chittorgarh",
                ].map((term, i) => (
