...
export const metadata = {
  ...
  description: "Luxury wedding planning in Jaipur by Yash Soni Studio. From intimate ceremonies to grand palace weddings — full-service planning with zero compromise.",
  keywords: [
