    ...
    <div ref={containerRef} className="bg-[#FAF9F6] text-[#1A1A1A] w-full min-h-screen overflow-hidden selection:bg-[#D4AF37] selection:text-white">
      ...
      <section className="relative w-full h-screen flex items-end pb-24 md:pb-32 px-6 md:px-12 lg:px-24">
        ...
        >
          ...
          <h1 className="font-['Runiga'] text-5xl md:text-7xl lg:text-[100px] leading-[0.85] text-[#1A1A1A] mb-8">Mastering The Royal Wedding</h1>
          <p className="font-['Amandine'] text-3xl md:text-5xl text-[#D4AF37] mb-10">Curating the most elite wedding experiences in Rajasthan</p>
      ...
      <section className="py-32 bg-[#1A1A1A] text-[#FAF9F6] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-24">
          ...
          <div className="space-y-24 border-l border-[#D4AF37]/30 ml-4 md:ml-12 pl-8 md:pl-16 relative">
            {[
            { title: "The Royal Swagat", desc: "Elephant processions and petal showers.", img: "/ivory_vintage_car_1776854011319.webp" },
            { title: "The Vibrant Sangeet", desc: "A night of high-octane performances.", img: "/ivory_palace_venue_1776853964418.webp" },
            { title: "The Sacred Pheras", desc: "A floating mandap under the moonlight.", img: "/ivory_sangeet_stage_1776854029383.webp" },
            { title: "The Grand Reception", desc: "A black-tie gala in the palace gardens.", img: "/ivory_hero_wedding_1776853928413.webp" }
          ].map((stage, idx) => (
              <motion.div
                key={idx}
      ...
      <section className="py-12 bg-[#1A1A1A] text-center px-6">
        <div className="max-w-5xl mx-auto border-t border-[#FAF9F6]/10 pt-12">
          <p className="font-sans text-[10px] md:text-xs text-[#FAF9F6]/30 leading-loose text-justify text-balance">
            Hire the best luxury wedding planner in Jaipur. Anchor Yash Soni and team organize flawless destination weddings across Rajasthan's finest heritage venues. Best luxury wedding planner in Jaipur execution managed by Anchor Yash Soni across Rambagh Palace, Fairmont, and elite destinations.
          </p>
        </div>
      </section>
