...
const SectionHeading = ({ subtitle, title, align = "left" }) => (
  <div className={`mb-16 ${align === "center" ? "text-center" : "text-left"}`}>
    ...
    >
      <p className="text-[#D4AF37] text-xs uppercase tracking-[0.3em] mb-4 font-bold flex items-center gap-2 justify-center md:justify-start">
...
export default function WeddingPlanning() {
  return (
    <div className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 mt-20">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
            ...
            <p className="text-gray-300 text-xl font-light leading-relaxed max-w-2xl mb-12 border-l-4 border-[#D4AF37] pl-8">
            ...
            <Link href="/contact">
              <button className="px-12 py-5 bg-[#D4AF37] text-black font-bold uppercase tracking-widest hover:bg-white transition-colors rounded-full shadow-[0_0_30px_rgba(212,175,55,0.4)]">
      ...
      <section className="py-32 container mx-auto px-4 border-b border-[#D4AF37]/20">
         <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
               ...
               <p className="text-gray-200 text-xl leading-relaxed mb-8 font-light">
                  I've stood on 1000+ stages. I've seen decorators arrive late. I've tasted cold food. I know exactly <strong className="text-[#D4AF37]">who delivers</strong> and who just talks.
               </p>
               <div className="bg-[#111] p-10 rounded-3xl border border-[#D4AF37]/30 shadow-2xl">
            ...
            <div className="relative h-[600px] w-full rounded-3xl overflow-hidden order-1 md:order-2 border border-[#D4AF37]/30">
               ...
               <div className="absolute bottom-8 left-8 bg-black/80 backdrop-blur-md p-6 rounded-2xl border border-[#D4AF37]/50">
                  <p className="text-[#D4AF37] text-2xl font-display font-bold">"I don't just host. I oversee."</p>
               </div>
            </div>
         </div>
      </section>
      ...
      <section className="py-32 bg-[#0a0a0a]">
         <div className="container mx-auto px-4">
            ...
            <div className="relative mt-24 max-w-5xl mx-auto">
               {/* Central Gold Line */}
               <div className="absolute left-8 md:left-1/2 top-0 h-full w-[2px] bg-gradient-to-b from-[#D4AF37] via-[#D4AF37]/50 to-transparent md:-translate-x-1/2"></div>
      ...
      <section className="py-32 bg-[#080808] border-y border-[#D4AF37]/20">
          <div className="container mx-auto px-4 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px] p-4 bg-[#111] rounded-3xl border border-[#D4AF37]/30 relative">
                  {/* Overlay Text */}
      ...
      <section className="py-32 text-center relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 relative z-10">
            ...
            <Link href="/contact">
               <button className="px-14 py-6 bg-[#D4AF37] text-black font-bold uppercase tracking-widest hover:scale-105 transition-transform rounded-full shadow-2xl text-lg">
...
const ListItem = ({ text }) => (
  <div className="flex gap-4 items-start group">
     <CheckCircle className="w-6 h-6 text-[#D4AF37] shrink-0 group-hover:scale-110 transition-transform" />
...
const TimelineItem = ({ step, title, desc, align, icon }) => (
  <div className={`flex flex-col md:flex-row gap-10 mb-24 relative ${align === 'right' ? 'md:flex-row-reverse' : ''}`}>
      {/* Center Icon */}
      <div className="absolute left-8 md:left-1/2 top-0 w-16 h-16 bg-[#0a0a0a] border-2 border-[#D4AF37] rounded-full md:-translate-x-1/2 z-10 flex items-center justify-center text-[#D4AF37] shadow-[0_0_30px_rgba(212,175,55,0.3)]">
          {icon}
      </div>
      
      {/* Content */}
      <div className={`w-full md:w-1/2 pl-24 md:pl-0 ${align === 'right' ? 'md:text-left md:pr-24' : 'md:text-right md:pl-24'}`}>
         <span className="text-[#D4AF37] font-bold uppercase tracking-widest text-sm mb-3 block">Step {step}</span>
...
const VendorCard = ({ title, icon, desc, bgImage }) => (
  <div className="relative h-96 rounded-3xl overflow-hidden group border border-[#D4AF37]/30 transition-all hover:scale-[1.02] hover:border-[#D4AF37]">
     ...
     <div className="absolute bottom-0 left-0 p-8">
        <div className="mb-4 text-[#D4AF37] w-14 h-14 bg-[#D4AF37]/10 rounded-2xl flex items-center justify-center backdrop-blur-md border border-[#D4AF37]/50">{icon}</div>
...
const MoodboardImage = ({ img, span = "", label }) => (
    <div className={`relative group overflow-hidden rounded-2xl border border-[#D4AF37]/20 ${span}`}>
        ...
        <div className="absolute bottom-4 left-4">
            <p className="text-white/80 text-xs uppercase tracking-widest font-bold group-hover:text-[#D4AF37] transition-colors">{label}</p>
        </div>
    </div>
);
