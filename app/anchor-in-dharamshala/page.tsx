...
const personSchema = {
  ...
  description: "Professional event anchor with 5+ years and 700+ shows. Specialist in Dharamshala's high-altitude luxury sector, executing explosive bilingual ceremonies at Taj Dharamshala and Hyatt Regency.",
  url: `https://${DOMAIN}`,
