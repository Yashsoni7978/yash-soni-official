...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 1,100+ events. Specialist in Chennai's coastal luxury sector, executing flawless ceremonies at Taj Fisherman's Cove and ITC Grand Chola.",
  url: `https://${DOMAIN}`,
