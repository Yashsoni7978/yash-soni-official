...
import { ArrowRight, Award, Briefcase, Building2, CalendarCheck, CheckCircle2, Crown, Flower2, Gem, Globe, Heart, Landmark, MapPin, Mic2, Minus, Music2, Plus, ShieldCheck, Sparkles, Star, Users, Waves } from "lucide-react";

const GOLD = "#D4AF37";
const WA = "https://wa.me/917737877978?text=Hi%20Yash!%20I%27m%20planning%20a%20destination%20wedding%20in%20Chennai.%20Can%20you%20check%20availability%3F";
...
const CHENNAI_IDENTITY = [
  ...
  {
    icon: Globe,
    title: "Bilingual Intellectual Bridging",
    desc: "Chennai weddings demand absolute respect for tradition (Brahminical or industrial legacy) mixed with a highly modern, global corporate outlook. Yash executes the perfect cross-over: from highly respectul unscripted executive English moderation for the NRIs and founders, to seamless code-switching into deep Hindi/English hype to drive the intense Sangeet dance floor."
  },
];
...
const SERVICES = [
  {
    icon: Crown,
    title: "Fisherman's Cove Galas",
    desc: "Executing sprawling, visually overwhelming VIP destination events utilizing the absolute coastal scale of the Taj property with perfect coastal poise.",
    tag: "Exclusive"
  },
  {
    icon: Building2,
    title: "ITC Grand Chola Summits",
    desc: "Generating massive event momentum within imperial ballroom architectures, utilizing grand scales to centralize the VIP energy.",
    tag: "Grandeur"
  },
  {
    icon: Briefcase,
    title: "International MNC Retreats",
    desc: "Unscripted, zero-notes hosting for high-stakes leadership symposiums holding strategic offsites along the Chennai coastline.",
    tag: "Corporate"
  },
  {
    icon: Sparkles,
    title: "ECR Beachside Sangeets",
    desc: "Calibrating the host's tone to match the high-energy coastal atmosphere while ensuring the ceremony maintains professional VIP pacing.",
    tag: "Wedding"
  },
];

const VENUES = [
  { name: "Taj Fisherman's Cove", tag: "Coastal Apex", icon: Crown },
  { name: "ITC Grand Chola", tag: "Imperial Grandeur", icon: Building2 },
  { name: "The Leela Palace Chennai", tag: "Seafront Luxury", icon: Gem },
  { name: "Taj Connemara", tag: "Heritage Command", icon: Landmark },
  { name: "InterContinental Chennai", tag: "Boutique Beachfront", icon: Waves },
  { name: "Sheraton Grand ECR", tag: "Contemporary Scale", icon: Star },
  { name: "Radisson Blu Resort Temple Bay", tag: "Massive Shoreline", icon: MapPin },
  { name: "Park Hyatt Chennai", tag: "Urban Sophistication", icon: Heart },
];
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/backgrounds/chennai_bg.webp" alt="Best Anchor in Chennai — VIP Luxury Coastal Weddings" fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" />
        ...
        <div className="relative z-20 text-center px-5 max-w-6xl mx-auto">
          ...
          >
            <div className="mb-8 inline-flex items-center gap-3 border border-[#D4AF37]/50 px-6 py-2.5 rounded-full bg-black/60 backdrop-blur-xl shadow-[0_0_24px_rgba(212,175,55,0.2)]">
              ...
              <span className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em]">Best Event Anchor · Chennai · Coastal Luxury Apex</span>
            </div>
            ...
            <p className="text-lg md:text-2xl text-zinc-300 max-w-2xl mx-auto font-light mb-12 leading-relaxed">
              The absolute apex of <G>highly-prestigious coastal and imperial destination weddings</G>, commanding unscripted VIP energy at Taj Fisherman's Cove and ITC Grand Chola.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <Reveal>
              ...
              <p className="text-zinc-400 text-lg md:text-xl mb-6 leading-relaxed font-light">
                With 8+ years on stage and 1,100+ events handled instinctively, <strong className="text-white">Anchor Yash Soni</strong> represents the absolute pinnacle of luxury coastal destination hosting across South India.
              </p>
              <p className="text-zinc-400 text-base md:text-lg mb-6 leading-relaxed font-light">
                Chennai operates as a definitive sanctuary for India's industrial and corporate royalty. You are dealing with vast imperial architectures like ITC Grand Chola where <strong className="text-[#D4AF37]">sweeping ballroom scale and international corporate demographics</strong> requires flawless execution. Yash steps into these sprawling architectures and manufactures incredibly tight, explosive dancing energy entirely organically, pulling the VIPs together unscripted.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Reveal>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash in Chennai" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" />
                </div>
              </Reveal>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Why Chennai is Different</p>
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight leading-tight mb-4">
              The ECR Corridor Demands<br />an <G>Elite Frequency.</G>
            </h2>
            <p className="text-zinc-400 text-sm md:text-base leading-relaxed max-w-2xl mb-14 font-light">
              Chennai blends absolute industrial heritage with sprawling, ultra-modern luxury infrastructure. The properties here feature imperial ballroom architectures that scatter massive soundscapes, and the demographic is decisively weighted towards international and pan-India corporate tiers. An anchor here cannot just be loud and generic. He must possess razor-sharp cultural intelligence to navigate VIP corporate mechanics, the linguistic polish to match high-end heritage, and the unscripted power to detonate a Sangeet against the aggressively humid coastal scale.
            </p>
          </Reveal>
          <div className="grid md:grid-cols-3 gap-5">
            {CHENNAI_IDENTITY.map((item, i) => (
          ...
          <Reveal>
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight">
                Imperial Balrooms to<br /><G>ECR Beachside Hype.</G>
              </h2>
            </div>
          </Reveal>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-black uppercase">Chennai's Best. <G>Known From Inside.</G></h2>
            </div>
          </Reveal>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">The Imperial Challenge</p>
          ...
          <Reveal delay={0.1}>
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "High-Voltage Party Hype", sub: "Explosive, unscripted momentum" },
                { label: "Elite English Protocol", sub: "Definitive VIP corporate integration" },
                { label: "Ballroom Acoustic Control", sub: "Defeating massive indoor sound loss" },
                { label: "ITC Chola Architecture Flow", sub: "Unshakeable crowd compression" },
              ].map((item, i) => (
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-5.webp","/gallery-2.webp","/gallery-1.webp","/gallery-4.webp","/gallery-3.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni Chennai event ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" />
                </div>
              ))}
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group">
              <Image src="/backgrounds/chennai_bg.webp" alt="Chennai Event Command" fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" />
              ...
              <div className="absolute bottom-5 left-5 right-5 bg-black/60 backdrop-blur-sm border border-[#D4AF37]/20 rounded-xl p-4">
                <p className="text-[#D4AF37] text-[9px] font-bold uppercase tracking-widest mb-1">Chennai · The Coastal Apex</p>
                <p className="text-white text-xs">Commanding extreme VIP intimacy at properties like Taj Fisherman's Cove and driving unstoppable energy across massive ballrooms.</p>
              </div>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            ...
            <div className="p-5 rounded-2xl bg-[#D4AF37]/8 border border-[#D4AF37]/25">
              <div className="flex items-center gap-3 text-white font-bold mb-2 text-sm">
                <ShieldCheck size={16} className="text-[#D4AF37]" /> The "VVIP South India" Guarantee
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black uppercase">Real Words. <G>Chennai Events.</G></h2>
            </div>
          </Reveal>
          <div className="grid md:grid-cols-3 gap-5">
        ...
        <div className="flex marquee whitespace-nowrap gap-12">
          {[...Array(2)].map((_, r) => (
            <div key={r} className="flex gap-12 shrink-0">
              {["Taj Fisherman's Executive","ITC Grand Chola Galas","Coastal ECR Sangeets","Chennai Industrial Hub","Bilingual English/Hindi","Dravidian Heritage Host","Cross-Cultural Elite Weddings","4.9★ Rated","International Summit Moderation"].map((t, i) => (
        ...
        <div className="max-w-4xl mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black uppercase">Chennai <G>Anchor FAQ.</G></h2>
            </div>
          </Reveal>
          <div className="flex flex-col gap-3">
            {FAQS.map((faq, idx) => (
              <Reveal key={idx} delay={idx * 0.025}>
                <FAQItem q={faq.q} a={faq.a} id={`faq-chennai-${idx}`} />
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <footer className="py-16 border-t border-white/10 bg-black text-center text-zinc-600">
        <div className="container mx-auto px-5">
          ...
          <p className="text-[11px] opacity-40 uppercase tracking-widest">
            © {new Date().getFullYear()} ANCHOR YASH SONI · CHENNAI (TN), INDIA
          </p>
        </div>
      </footer>
    </main>
