...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 1,100+ events. Specialist in Rishikesh's luxury wellness sector, overcoming strictly Satvik environments to produce high-voltage events for VIPs at Taj Rishikesh.",
  url: `https://${DOMAIN}`,
