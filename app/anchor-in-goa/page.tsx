...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 1,100+ events. Specialist in Goa's massive open-air luxury weddings, managing complex beach acoustics and high-net-worth bilingual networking.",
  url: `https://${DOMAIN}`,
