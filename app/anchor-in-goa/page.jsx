...
import { ArrowRight, Award, Building2, CalendarCheck, CheckCircle2, Crown, Flower2, Gem, Globe, Heart, MapPin, Mic2, Minus, Music2, Plane, Plus, ShieldCheck, Sparkles, Star, Sunset, Users, Waves } from "lucide-react";
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/backgrounds/goa_bg.webp"
            alt="Best Anchor in Goa — NRI & Luxury Beach Weddings"
        ...
        <div className="relative z-20 text-center px-5 max-w-6xl mx-auto">
          ...
          >
            <div className="mb-8 inline-flex items-center gap-3 border border-[#D4AF37]/50 px-6 py-2.5 rounded-full bg-black/60 backdrop-blur-xl shadow-[0_0_24px_rgba(212,175,55,0.2)]">
              ...
              <span className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em]">Best Event Anchor · Goa · The Ultimate Coast</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <Reveal>
              ...
              <p className="text-zinc-400 text-base md:text-lg mb-6 leading-relaxed font-light">
                Goa functions precisely at the limits of extreme scale. You are dealing with massive <strong className="text-[#D4AF37]">oceanfront acoustic dispersal</strong>, strictly enforced property decibel limits, and an audience heavily skewed towards international, highly-educated NRI families. Yash steps into these infinite spaces and manufactures intense, raw dancing energy entirely organically.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Reveal>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group">
                  <img src="/intro-portrait-bottom.webp" className="w-full h-full object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" alt="Anchor Yash in Goa" />
                </div>
              </Reveal>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Why Goa is Different</p>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-4.webp","/gallery-2.webp","/gallery-5.webp","/gallery-1.webp","/gallery-3.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0">
                  <img
                    src={src}
                    alt={`Anchor Yash Soni Goa event ${i + 1}`}
          ...
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group">
              ...
              <div className="absolute bottom-5 left-5 right-5 bg-black/60 backdrop-blur-sm border border-[#D4AF37]/20 rounded-xl p-4">
                <p className="text-[#D4AF37] text-[9px] font-bold uppercase tracking-widest mb-1">Goa · Indian Ocean Summit</p>
