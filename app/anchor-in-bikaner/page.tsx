...
const localBusinessSchema = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 28.0229, longitude: 73.3119 },
...
const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://yashsoni.in" },{ "@type": "ListItem", position: 2, name: "Locations", item: "https://yashsoni.in/locations" },{ "@type": "ListItem", position: 3, name: "Anchor in Bikaner", item: "https://yashsoni.in/anchor-in-bikaner" }] };

const webPageSchema = {
  "@context": "https://schema.org", "@type": "WebPage",
  name: "Best Anchor in Bikaner | Yash Soni — Heritage Wedding Specialist",
  url: "https://yashsoni.in/anchor-in-bikaner",
  description: "Anchor Yash Soni is Bikaner's top-rated wedding anchor and emcee — 4.9★ across 200+ reviews. Specialist in heritage weddings, corporate offsites, and destination events in Bikaner, Rajasthan.",
  inLanguage: "en-IN",
...
const howToSchema = {
  ...
  name: "How to Hire the Best Anchor or Emcee for a Bikaner Destination Wedding",
  description: "Step-by-step process to book Anchor Yash Soni for heritage weddings and corporate events in Bikaner, Rajasthan.",
  totalTime: "PT48H",
  step: [
    { "@type": "HowToStep", position: 1, name: "Check Availability", text: "WhatsApp +91 7737877978 with your Bikaner event date and venue. Peak season dates fill 6+ months ahead." },
    { "@type": "HowToStep", position: 2, name: "Receive Quote", text: "A comprehensive quote covering travel, stay, and event hosting logistics for Bikaner is provided within the hour." },
...
export const metadata: Metadata = {
  title: "Best Anchor in Bikaner | Yash Soni — Heritage Wedding Specialist",
  description: "Anchor Yash Soni is Bikaner's 4.9★ rated wedding anchor and emcee — specialist in heritage weddings, grand Sangeets, and corporate destination events.",
  alternates: { canonical: "https://yashsoni.in/anchor-in-bikaner" },
  openGraph: { title: "Best Anchor in Bikaner | Yash Soni", description: "4.9★ rated wedding anchor and emcee in Bikaner. Heritage weddings and grand destination events.", url: "https://yashsoni.in/anchor-in-bikaner", siteName: "Anchor Yash Soni", locale: "en_IN", type: "website", images: [{ url: "/og-image.webp", width: 1200, height: 630, alt: "Best Anchor in Bikaner — Yash Soni" }] },
  twitter: { card: "summary_large_image", title: "Best Anchor in Bikaner | Yash Soni", description: "4.9★ · 200+ reviews. Bikaner's top anchor, emcee, and wedding host.", images: [{ url: "/og-image.webp", width: 1200, height: 630 }] },
};
