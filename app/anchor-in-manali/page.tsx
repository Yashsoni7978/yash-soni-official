...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 700+ shows. Specialist in Manali's alpine luxury sector, executing explosive bilingual Sangeets and corporate offsites at Span Resort and Baragarh Resort.",
  url: `https://${DOMAIN}`,
