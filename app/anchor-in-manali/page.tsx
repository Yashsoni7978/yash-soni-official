...
const personSchema = {
  ...
  description: "Professional event anchor with 5+ years and 700+ shows. Specialist in Manali's alpine luxury sector, executing explosive bilingual Sangeets and corporate offsites at Span Resort and Baragarh Resort.",
  url: `https://${DOMAIN}`,
...
const howToSchema = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: `How to Hire the Best Anchor in Manali`,
  description: `Step-by-step process to book Anchor Yash Soni for weddings and corporate events in Manali.`,
  totalTime: "PT48H",
  step: [
    { "@type": "HowToStep", position: 1, name: "Check Availability", text: `WhatsApp +91 7737877978 with your event dates and venues in Manali.` },
