...
import { ArrowRight, Award, Building2, CalendarCheck, CheckCircle2, Crown, Flower2, Gem, Globe, Heart, MapPin, Mic2, Minus, Music2, Plus, ShieldCheck, Sparkles, Star, Users, Zap } from "lucide-react";
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
               ...
               <Reveal>
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash in Udaipur" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" quality={75} />
                  </div>
               </Reveal>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Why Udaipur is Different</p>
        ...
        <div className="max-w-5xl mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">The Difference Is Visible</p>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p className="text-[#B5952F] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">The NRI Challenge</p>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-1.webp", "/gallery-2.webp", "/gallery-3.webp", "/gallery-4.webp", "/gallery-5.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni live event Udaipur ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              ))}
            </div>
          ))}
      ...
      <section className="py-20 md:py-28 px-5 md:px-12  border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group"><Image src="/backgrounds/udaipur_bg.webp" alt="Udaipur Lake Palace view" fill sizes="(max-width:768px) 100vw, 50vw" className="object-cover group-hover:scale-105 transition-transform duration-1000" quality={75} />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute bottom-5 left-5 right-5 /60 backdrop-blur-sm border border-[#D4AF37]/20 rounded-xl p-4">
                <p className="text-[#B5952F] text-[9px] font-bold uppercase tracking-widest mb-1">Udaipur · Lake Pichola</p>
          ...
          <Reveal delay={0.1}>
            ...
            <div className="p-5 rounded-2xl bg-[#D4AF37]/8 border border-[#D4AF37]/25">
              <div className="flex items-center gap-3 text-white font-bold mb-2 text-sm">
                <ShieldCheck size={16} className="text-[#B5952F]" /> Crisis-Proof at Palace Venues
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            {[
              ...
              },
              {
                ...
                title: "Best Sangeet Emcee in Udaipur",
                desc: "High-energy Sangeet nights, unscripted crowd games, 500–1,500 guests. Dance floors packed until 4 AM. Udaipur's top-rated Sangeet emcee.",
                keywords: ["best sangeet emcee udaipur", "sangeet anchor udaipur", "sangeet host udaipur"],
              },
              {
                label: "Corporate Host · Corporate MC",
                title: "Best Corporate Emcee in Udaipur",
                desc: "Award nights, product launches, annual galas at premium properties. Sharp, bilingual, brand-aligned corporate MC hosting.",
                keywords: ["best corporate emcee udaipur", "corporate anchor udaipur", "corporate mc udaipur", "corporate host udaipur"],
              },
              {
          ...
          <Reveal>
            <div className="border border-white/5 rounded-2xl p-6 bg-[#0a0a0a]">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  "Best Anchor in Udaipur", "Best Emcee in Udaipur", "Best Host in Udaipur",
                  "Wedding Anchor Udaipur", "Wedding Emcee Udaipur", "Wedding Host Udaipur",
                  "Corporate Anchor Udaipur", "Corporate Emcee Udaipur", "Corporate MC Udaipur",
                  "Best Anchor in Rajasthan", "Best Emcee in Rajasthan",
                  "Sangeet Anchor Udaipur", "Sangeet Emcee Udaipur", "Sangeet Host Udaipur",
                  "Haldi Anchor Udaipur", "Mehendi Host Udaipur",
                  "Birthday Anchor Udaipur", "Birthday Emcee Udaipur",
                  "Master of Ceremonies Udaipur", "MC for Wedding Udaipur",
                  "NRI Wedding Emcee Udaipur", "Bilingual Host Udaipur",
                  "Top Anchor Udaipur", "Top Emcee Udaipur", "Event Host Udaipur",
                ].map((term, i) => (
