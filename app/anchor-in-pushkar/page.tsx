...
const personSchema = {
  ...
  description: "Professional event anchor with 5+ years and 700+ shows. Specialist in Pushkar's unique event dichotomy: driving massive Sangeet energy under strict traditional venue protocols, and hosting ultra-premium NRI weddings across the Westin-Ananta corridor.",
  url: `https://${DOMAIN}`,
...
const howToSchema = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: `How to Hire the Best Anchor in Pushkar`,
  description: `Step-by-step process to book Anchor Yash Soni for weddings and corporate events in Pushkar.`,
  totalTime: "PT48H",
  step: [
    { "@type": "HowToStep", position: 1, name: "Check Availability", text: `WhatsApp +91 7737877978 with your event dates and venues in Pushkar.` },
