...
import { ArrowRight, Award, Building2, CalendarCheck, CheckCircle2, Crown, Gem, Globe, Heart, MapPin, Mic2, Minus, Music2, Plane, Plus, ShieldCheck, Sparkles, Star, Sun, TreePine, Users } from "lucide-react";
  ...
  return (
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0"><div className="relative w-full h-full"><Image src="/backgrounds/pushkar_bg.webp" alt="Best Anchor in Pushkar — NRI & Luxury Desert Weddings" fill priority sizes="100vw" className="object-cover slow-zoom" quality={75} /></div>
        ...
        <div className="relative z-20 text-center px-5 max-w-6xl mx-auto">
          ...
          >
            ...
            <h1 className="font-black uppercase tracking-tighter leading-[0.82] mb-8">
              ...
              <span
                className="block text-[14vw] md:text-[10vw] lg:text-[8rem] bg-clip-text text-transparent bg-cover bg-center mt-2 pb-4 gold-gradient-text"
              >
                PUSHKAR
              </span>
            </h1>
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Reveal>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group relative"><Image src="/intro-portrait-bottom.webp" alt="Anchor Yash in Pushkar" fill sizes="(max-width:768px) 50vw, 30vw" className="object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              </Reveal>
            </div>
          </div>
            ...
            <div key={r} className="flex gap-5 shrink-0">
              {["/gallery-3.webp","/gallery-4.webp","/gallery-1.webp","/gallery-5.webp","/gallery-2.webp"].map((src, i) => (
                <div key={i} className="w-56 h-72 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-white/8 shrink-0 relative">
                  <Image src={src} alt={`Anchor Yash Soni Pushkar event ${i + 1}`} fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
                </div>
              ))}
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="aspect-video rounded-2xl overflow-hidden border border-[#D4AF37]/20 relative group">
              <Image src="/backgrounds/pushkar_bg.webp" alt="Pushkar Event Command" fill sizes="(max-width:768px) 224px, 288px" className="object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" quality={75} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              { icon: MapPin, label: "Kishangarh", href: "/anchor-in-rajasthan", desc: "Transit Route" },
