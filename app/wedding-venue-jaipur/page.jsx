    ...
    <div ref={containerRef} className="bg-[#FAF9F6] text-[#1A1A1A] w-full min-h-screen overflow-hidden selection:bg-[#4A044E] selection:text-white">
      ...
      <section className="relative w-full h-screen flex items-end pb-24 md:pb-32 px-6 md:px-12 lg:px-24">
        ...
        >
          ...
          <p className="font-['Amandine'] text-3xl md:text-5xl text-[#B5952F] mb-10">Securing Jaipur's most breathtaking properties</p>
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-[#FAF9F6]">
        ...
        >
          <span className="font-['Orange_Avenue'] text-4xl text-[#B5952F] mb-6 block">The First Step</span>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 px-2">
            <motion.div variants={fadeInUp} className="group relative aspect-[3/4] md:h-[90vh] overflow-hidden rounded-lg">
              <Image src="/premium_events/palace_wedding_decor.webp" alt="Palace Venue" fill className="object-cover transition-transform duration-[2s] ease-out group-hover:scale-110"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
            </motion.div>
            <motion.div variants={fadeInUp} className="group relative aspect-[3/4] md:h-[90vh] md:mt-32 overflow-hidden rounded-lg">
              <Image src="/premium_events/outdoor_garden_wedding.webp" alt="Resort Venue" fill className="object-cover transition-transform duration-[2s] ease-out group-hover:scale-110"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
            </motion.div>
            <motion.div variants={fadeInUp} className="group relative aspect-[3/4] md:h-[90vh] overflow-hidden rounded-lg">
              <Image src="/premium_events/luxury_dining_setup.webp" alt="Banquet Venue" fill className="object-cover transition-transform duration-[2s] ease-out group-hover:scale-110"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
            </motion.div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-10">
            ...
            <Link href="/anchor-in-rajasthan" className="font-sans text-[#4A044E] font-medium hover:underline">Explore Cities &gt;</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="#" className="flex items-center bg-[#FDF4FF] rounded-r-full hover:shadow-lg transition-shadow overflow-hidden group h-32 md:h-40">
              ...
              <div className="h-full aspect-square relative rounded-full overflow-hidden border-4 border-white mr-2 group-hover:scale-105 transition-transform">
                <Image src="/premium_events/palace_wedding_decor.webp" alt="Palaces" fill className="object-cover"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
              </div>
            </a>
            ...
            <a href="#" className="flex items-center bg-[#FAF5FF] rounded-r-full hover:shadow-lg transition-shadow overflow-hidden group h-32 md:h-40">
              ...
              <div className="h-full aspect-square relative rounded-full overflow-hidden border-4 border-white mr-2 group-hover:scale-105 transition-transform">
                <Image src="/premium_events/outdoor_garden_wedding.webp" alt="Resorts" fill className="object-cover"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
              </div>
            </a>
            ...
            <a href="#" className="flex items-center bg-[#F3E8FF] rounded-r-full hover:shadow-lg transition-shadow overflow-hidden group h-32 md:h-40">
              ...
              <div className="h-full aspect-square relative rounded-full overflow-hidden border-4 border-white mr-2 group-hover:scale-105 transition-transform">
                <Image src="/ivory_hero_wedding_1776853928413.webp" alt="Estates" fill className="object-cover"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
              </div>
            </a>
            ...
            <a href="#" className="flex items-center bg-[#FCE7F3] rounded-r-full hover:shadow-lg transition-shadow overflow-hidden group h-32 md:h-40">
              ...
              <div className="h-full aspect-square relative rounded-full overflow-hidden border-4 border-white mr-2 group-hover:scale-105 transition-transform">
                <Image src="/premium_events/theme_wedding_setup.webp" alt="Lawns" fill className="object-cover"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
              </div>
            </a>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.05)] flex flex-col group hover:-translate-y-2 transition-all duration-500">
              <div className="w-full h-64 relative overflow-hidden">
                <Image src="/premium_events/grand_wedding_venue.webp" alt="Negotiation" fill className="object-cover group-hover:scale-105 transition-transform duration-700"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
              </div>
      ...
      <section className="py-24 bg-[#1A1A1A] text-[#FAF9F6] px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="font-['Runiga'] text-5xl md:text-7xl text-[#B5952F] mb-4">Venue Sourcing</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="border border-[#D4AF37]/50 p-10 relative bg-gradient-to-b from-[#4A044E]/20 to-transparent transform md:-translate-y-4 shadow-[0_0_30px_rgba(212,175,55,0.1)] rounded-lg">
              ...
              <h3 className="font-['The_Seasons'] text-3xl mb-2 text-[#B5952F]">Full Wedding Management</h3>
              ...
              <ul className="space-y-4 font-sans font-light text-sm text-gray-300 mb-10">
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> Free venue sourcing & negotiation</li>
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> Complete decor design and setup</li>
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> All artist and vendor bookings</li>
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> Full guest travel & hospitality management</li>
              </ul>
            ...
            <div className="border border-white/10 p-10 hover:border-[#D4AF37]/50 transition-colors duration-500 group rounded-lg">
              <h3 className="font-['The_Seasons'] text-3xl mb-2 group-hover:text-[#B5952F] transition-colors">Consulting Only</h3>
              ...
              <ul className="space-y-4 font-sans font-light text-sm text-gray-400 mb-10">
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> Curated list of properties based on budget</li>
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> Arranging hotel visits and tours</li>
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> One-time contract negotiation</li>
                <li className="flex gap-3"><span className="text-[#B5952F]">✦</span> Handing over the booking to you</li>
              </ul>
            </div>
          </div>
        </div>
