...
const G = ({ children }) => (
  <span
    ...
    style={{ backgroundImage: "url('/texture/mandhawa.png')", backgroundColor: GOLD }}
  >
    {children}
  </span>
);
    ...
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
        ...
        <div className="relative z-20 text-center px-5 max-w-6xl mx-auto">
          ...
          >
            <div className="mb-8 inline-flex items-center gap-3 border border-[#D4AF37]/50 px-6 py-2.5 rounded-full bg-black/60 backdrop-blur-xl shadow-[0_0_24px_rgba(212,175,55,0.2)]">
              ...
              <span className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em]">Best Event Anchor · Mandawa · The Open-Air Gallery City</span>
            </div>
            <h1 className="font-black uppercase tracking-tighter leading-[0.82] mb-8">
              ...
              <span
                ...
                style={{ backgroundImage: "url('/texture/mandhawa.png')" }}
              >
                MANDAWA
              </span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <Reveal>
              ...
              <p className="text-zinc-400 text-base md:text-lg mb-6 leading-relaxed font-light">
                From the painted courtyards of <strong className="text-[#D4AF37]">Castle Mandawa</strong> to the rooftop stages overlooking the Shekhawati desert, Yash brings a level of cultural awareness and event command that transforms extraordinary venues into extraordinary experiences.
              </p>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Why Mandawa is Different</p>
      ...
      <section className="py-20 md:py-28 px-5 md:px-12 border-b border-white/5">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">The Mandawa Challenge</p>
          ...
          <Reveal delay={0.1}>
            ...
            <div className="p-5 rounded-2xl bg-[#D4AF37]/8 border border-[#D4AF37]/25">
              <div className="flex items-center gap-3 text-white font-bold mb-2 text-sm">
                <ShieldCheck size={16} className="text-[#D4AF37]" /> Heritage Property Logistics Management
              </div>
