...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 700+ shows. Specialist in Haridwar's high-altitude spiritual luxury sector, executing flawless bilingual ceremonies at Pilibhit House and the Ganges ghats.",
  url: `https://${DOMAIN}`,
