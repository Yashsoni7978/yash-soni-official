...
import { ArrowRight, Award, Briefcase, Building2, CalendarCheck, CheckCircle2, Crown, Gem, Heart, MapPin, Mic2, Minus, Music2, Plane, Plus, ShieldCheck, Ship, Sparkles, Star, Users, Waves } from "lucide-react";
  ...
  return (
    <main className="bg-[#050505] text-white min-h-screen font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0"><div className="relative w-full h-full"><Image src="/backgrounds/alibaug_bg.webp" alt="Best Anchor in Alibaug — VIP Luxury Coastal Weddings" fill priority sizes="100vw" className="object-cover slow-zoom" /></div>
