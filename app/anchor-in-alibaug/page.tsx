...
const personSchema = {
  ...
  description: "Professional event anchor with 4+ years and 700+ shows. Specialist in Alibaug's highly exclusive, VIP-dense luxury weddings, managing complex coastal logistics and Mumbai's high-net-worth business crowds.",
  url: `https://${DOMAIN}`,
