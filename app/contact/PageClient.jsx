          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-3xl space-y-8 shadow-xl">
             ...
             <div className="bg-[#0a0a0a] border border-white/5 p-5 rounded-2xl shadow-xl">
               <a
                 href="https://www.google.com/search?kgmid=/g/11w1fnfjrs"
                 target="_blank"
                 rel="noopener noreferrer"
                 className="flex items-center gap-5 group"
               >
                 <div className="w-14 h-14 bg-[#111] rounded-2xl flex items-center justify-center border border-white/10 text-[#4285F4] group-hover:bg-[#4285F4] group-hover:text-white transition-colors duration-500 shadow-md shrink-0">
                 ...
                 <div>
                   <p className="text-gray-500 text-[10px] uppercase tracking-widest font-bold">Verified on Google</p>
                   <p className="text-lg font-bold text-white group-hover:text-[#4285F4] transition-colors">View on Google Maps</p>
                   <p className="text-xs text-gray-500 mt-0.5">See verified reviews, location and hours</p>
                 </div>
               </a>
             </div>
            {/* Why Book Now? */}
