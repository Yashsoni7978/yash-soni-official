...
const FAQItem = ({ q, a }) => {
  ...
  return (
    <div className="border-b border-neutral-800 last:border-0">
      ...
      >
        <span className="text-gray-300 group-hover:text-[#D4AF37] transition-colors font-medium">{q}</span>
...
export default function Contact() {
  ...
  return (
    <div className="bg-black text-white min-h-screen selection:bg-[#D4AF37] selection:text-black font-sans pt-32 pb-20">
      ...
      {/* --- AVAILABILITY TICKER --- */}
      <div className="fixed top-20 left-0 w-full bg-[#D4AF37] text-black text-[10px] md:text-xs font-bold uppercase tracking-widest py-2 z-20 overflow-hidden">
