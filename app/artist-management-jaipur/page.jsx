    ...
    <div ref={containerRef} className="bg-[#FAF9F6] text-[#1A1A1A] w-full min-h-screen overflow-hidden selection:bg-[#D4AF37] selection:text-white">
      ...
      <section className="relative w-full h-screen flex items-end pb-24 md:pb-32 px-6 md:px-12 lg:px-24">
        <motion.div style={{ y }} className="absolute inset-0 z-0">
          <Image
            src="/sangeet_hero_1776855109279.webp"
        ...
        >
          ...
          <h1 className="font-['Runiga'] text-5xl md:text-7xl lg:text-[100px] leading-[0.85] text-[#1A1A1A] mb-8">Mastering Global Performance</h1>
          <p className="font-['Amandine'] text-3xl md:text-5xl text-[#D4AF37] mb-10">Securing global talent for India's most prestigious stages</p>
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-[#FAF9F6]">
        ...
        >
          ...
          <h2 className="font-['The_Seasons'] text-4xl md:text-6xl text-[#1A1A1A] leading-tight mb-10">The right artist doesn't just perform. They transform the very air of your event.</h2>
          <p className="font-sans text-lg md:text-xl text-gray-600 font-light leading-relaxed">We manage the bridge between global celebrities and your private stage. From Bollywood icons to international symphonies, we handle the contracts, the riders, and the show.</p>
        </motion.div>
      </section>
      ...
      <section className="py-32 bg-[#1A1A1A] text-[#FAF9F6] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-24">
          ...
          <div className="space-y-24 border-l border-[#D4AF37]/30 ml-4 md:ml-12 pl-8 md:pl-16 relative">
            {[
            { title: "Talent Scouting", desc: "Matching the right energy to your crowd.", img: "/ivory_vintage_car_1776854011319.webp" },
            { title: "Technical Riders", desc: "Zero-compromise audio and hospitality setups.", img: "/ivory_palace_venue_1776853964418.webp" },
            { title: "The Performance", desc: "Seamless coordination and stage management.", img: "/ivory_sangeet_stage_1776854029383.webp" },
            { title: "The After-Show", desc: "Private meet-and-greets and VIP protocol.", img: "/ivory_hero_wedding_1776853928413.webp" }
          ].map((stage, idx) => (
              <motion.div
                key={idx}
