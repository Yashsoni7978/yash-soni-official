...
import {
  Star, ChevronLeft, ChevronRight, MapPin, CheckCircle2,
  Mic, Users, Award, UserCheck, ArrowRight, CalendarCheck,
  Sparkles, ShieldCheck, Quote, Play, Building2, Heart,
  GraduationCap, Landmark, Cake, Globe, Music2, Flower2
} from "lucide-react";
...
const SLIDER_IMAGES = [
  ...
  { src: "/gallery-6.webp", caption: "Award Night — Tonk Road" },
